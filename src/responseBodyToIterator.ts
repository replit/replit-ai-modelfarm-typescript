...
export default function responseBodyToIterator<T = any, R = any>(responseBody: ReadableStream<Uint8Array>, processJSON: (json: T) => R): AsyncGenerator<R, any, unknown> {
  return pipe(
